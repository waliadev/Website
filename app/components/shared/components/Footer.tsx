      ...
      <div className="bd-footer-top">
        ...
        <div className="bd-footer-brand">
          <div className="bd-footer-logo">
            <span className="bd-footer-broker">{FOOTER.BRAND.NAME1}</span>
            <span className="bd-footer-dash">{FOOTER.BRAND.NAME2}</span>
          </div>

          <p className="bd-footer-tagline">{FOOTER.BRAND.TAGLINE}</p>

          <div className="bd-footer-storeButtons">
            <a href={FOOTER.STORE_LINKS.APP_STORE} target="_blank">
              <img src={FOOTER.STORE_LINKS.APP_STORE} alt="App Store" />
            </a>

            <a href={FOOTER.STORE_LINKS.PLAY_STORE} target="_blank">
